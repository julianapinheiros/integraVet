    ...
    <div class="container tabela mt-2">
        <div class="row">
            <div class="col-6 CAO">
                ...
                <div class="col-12 conteudo">
                    <div class="col-4">
                        <span>Concentrado Hemácias</span>
                    </div>
                    <div class="col-4">
                        <span>09</span>
                    </div>
            ...
            <div class="col-6 GATO">
                <h2>Bolsas Felinas</h2>
                <div class="col-12 subTitulos">
                    <div class="col-4">
                        <span>Componente</span>
                    </div>
            ...
            <div class="botao col-12 text-center mt-4">
                <a class="btn btn-primary" aria-current="page" href="CadBolsa.html">Cadastrar Bolsa</a>
            </div>
        </div>        
    </div>
</body>
